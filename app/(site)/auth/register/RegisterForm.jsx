...
export default function RegisterForm({ salutationEnabled, phoneEnabled, companyEnabled }) {
  const [fields, setFields] = useState({
    name: '', email: '', password: '', confirmPassword: '',
    salutation: '', phone: '', company: '',
  });
  ...
  async function handleSubmit(e) {
    ...
    const res  = await fetch('/api/site-auth/register', {
      ...
      body:    JSON.stringify({ ...fields, trap }),
    });
        ...
        <div className="card-body p-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ position: 'absolute', left: '-9999px', opacity: 0, pointerEvents: 'none', height: 0, overflow: 'hidden' }} aria-hidden="true">
              <input type="text" name="_hp_website" value={trap} onChange={(e) => setTrap(e.target.value)} autoComplete="off" tabIndex={-1} />
            </div>
            ...
            {salutationEnabled && (
              <div className="mb-3">
                ...
                <select className="form-select" value={fields.salutation} onChange={(e) => set('salutation', e.target.value)}>
            ...
            <div className="mb-3">
              ...
              <input type="text" className="form-control" value={fields.name} onChange={(e) => set('name', e.target.value)} autoComplete="name" />
            </div>
            ...
            {companyEnabled && (
              <div className="mb-3">
                <label className="form-label">Company <span className="text-muted small">(optional)</span></label>
                <input
                  type="text"
