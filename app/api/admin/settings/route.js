...
export async function POST(req) {
  ...
  // active_locales must include the default_locale
  if (
    body.active_locales &&
    body.default_locale &&
    !body.active_locales.includes(body.default_locale)
  ) {
    return Response.json(
      { success: false, error: 'Default locale must be in active locales' },
      { status: 400 }
    );
  }
